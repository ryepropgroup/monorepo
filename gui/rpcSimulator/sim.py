...
def generate_random_values():
    return {
        "lj": {
            "p10val": random.uniform(0.0, 100.0),
            "p21val": random.uniform(0.0, 100.0),
            "p31val": random.uniform(0.0, 100.0),
            "p20val": random.uniform(0.0, 100.0),
            "p30val": random.uniform(0.0, 100.0),
            "p22val": random.uniform(0.0, 100.0),
            "p32val": random.uniform(0.0, 100.0),
            "t1val": random.uniform(-50.0, 150.0),
            "t2val": random.uniform(-50.0, 150.0),
            "pinjval": random.uniform(0.0, 100.0),
            "lcval": random.uniform(0.0, 100.0),
            "inj1val": random.uniform(0.0, 100.0),
            "inj2val": random.uniform(0.0, 100.0),
            "ignval": random.uniform(0.0, 100.0)
        },
        "valves": {
